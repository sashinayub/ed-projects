...
В данном разделе представлены кейсы, демонстрирующие мой опыт в сборе, документировании и анализе требований. Здесь отражены подходы к выявлению бизнес-потребностей, формализации требований и обеспечению их соответствия целям проекта для успешной реализации решений: брифы интервью с заказчиком, описание функциональных требований в виде сценариев использования (Use Case), User Story и критерии приемки, фиксация нефункциональных требований,  диаграммы UML, ER-диаграммы, контекстные диаграммы, User Story Map и способы приоритизации задач, спецификации по результатам разработки требований.

_Ряд кейсов, содержащихся в данном разделе:_
- [x] Планировщик задач внутри приложения банка;
- [x] Проектирование функции «Скачать все материалы курса»;
...
- [x] Разработка функции «Забронировать номер в отеле»;
- [x] Автоматизация процесса принятия денежных средств от клиента и начисления вознаграждения участникам;
- [x] Разработка функциональности системы каршеринга и заказа такси;
- [x] Функциональность «Фильтрация вещей по категории» в приложении «Цифровой гардероб»;
- [x] Функциональность «Публикация товара на маркетплейсе (витрине)" и «Оформление заказа в интернет-магазине»;
- [x] Составление UML-диаграмм для банковских операций.

Ссылка на папку с работами ["Мои проекты"](https://github.com/sashinayub/ed-projects/tree/7b878e2c30cce1766ff1f9600de622836ee109b4/%D0%9C%D0%BE%D0%B8%20%D0%BF%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D1%8B) и
 ["Сбор, документирование и анализ требований"](https://github.com/sashinayub/ed-projects/tree/1de22be9880beacc3830450c55e86a777c45103d/%D0%A1%D0%B1%D0%BE%D1%80%2C%20%D0%B4%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5%20%D0%B8%20%D0%B0%D0%BD%D0%B0%D0%BB%D0%B8%D0%B7%20%D1%82%D1%80%D0%B5%D0%B1%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B9)
...
## Диаграммы UML, ERD и другие диаграммы для описания ПО
  ...
  В данном разделе содержатся диаграммы UML (Activity Diagram, Class Diagam, Use Case Diagram, Sequence Diagram, диаграммы состояний и переходов (STD)), ER-диаграммы, контекстные диаграммы, User Story Map. При составлении диаграмм спользовались инструменты PlantUML, Miro, Draw.io, Figma. 
 - [x] Sequence Diagrams:
...
Подробнее в ["Визуализация и аналитика с помощью BI-систем"](https://github.com/sashinayub/ed-projects/tree/2542396815aa47c2195b126041e471d110b39049/%D0%92%D0%B8%D0%B7%D1%83%D0%B0%D0%BB%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F%20%D0%B8%20%D0%B0%D0%BD%D0%B0%D0%BB%D0%B8%D1%82%D0%B8%D0%BA%D0%B0%20%D1%81%20%D0%BF%D0%BE%D0%BC%D0%BE%D1%89%D1%8C%D1%8E%20BI-%D1%81%D0%B8%D1%81%D1%82%D0%B5%D0%BC)
