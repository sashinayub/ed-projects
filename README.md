...
В данном разделе представлены кейсы, демонстрирующие мой опыт в сборе, документировании и анализе требований. Здесь отражены подходы к выявлению бизнес-потребностей, формализации требований и обеспечению их соответствия целям проекта для успешной реализации решений: брифы интервью с заказчиком, описание функциональных требований в виде сценариев использования (Use Case), User Story и критерии приемки, фиксация нефункциональных требований,  диаграммы UML (Activity Diagram,  Class Diagam, Use Case Diagram, Sequence Diagram, диаграммы состояний и переходов (STD)), ER-диаграммы, контекстные диаграммы, User Story Map и способы приоритизации задач, спецификации по результатам разработки требований.
